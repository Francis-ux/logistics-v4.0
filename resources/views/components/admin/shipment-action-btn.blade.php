 ...
 <x-admin.links href="{{ route('admin.shipment.show', $shipment->uuid) }}" class="btn btn-info m-1">Shipment
     Details</x-admin.links>

 <x-admin.links href="{{ route('tracking.show', $shipment->uuid) }}" class="btn btn-secondary m-1">Track
     Shipment</x-admin.links>
